...
final class MongoResultSet implements ResultSet {
    ...
    MongoResultSet(List<String> columnNames, Map<String, Integer> columnTypes, List<List<Object>> rows) {
    ...
    private Object getByIndex(int columnIndex) throws SQLException {
        checkOpen();
    ...
    private Object getByLabel(String columnLabel) throws SQLException {
