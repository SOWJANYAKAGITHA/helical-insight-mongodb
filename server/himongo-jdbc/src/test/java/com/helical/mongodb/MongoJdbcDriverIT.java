...
public class MongoJdbcDriverIT {
    ...
    public static void setUpClass() throws Exception {
        ...
        try (MongoClient client = MongoClients.create(MongoClientSettings.builder()
                ...
                .build())) {
            MongoDatabase db = client.getDatabase("hi_demo");
            ...
            fail("HIMONGO_IT=true but MongoDB is not reachable at " + uri + ": " + e.getMessage());
        }
    }
    ...
    public static void tearDownClass() {
        ...
        try (MongoClient client = MongoClients.create(uri)) {
            client.getDatabase("hi_demo").getCollection(IT_COLLECTION).drop();
    ...
    public void rejectsInvalidCredentialsWithSanitizedError() {
        String badUri = "mongodb://hi_mongo:wrong_password@127.0.0.1:27017/hi_demo?authSource=admin";
    ...
    public void unreachableHostFailsWithinTimeout() {
        ...
        long start = System.currentTimeMillis();
        try {
            DriverManager.getConnection("mongodb://127.0.0.1:27018/hi_demo", props);
